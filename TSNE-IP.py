...
checkpoints_way = '/home/hndx/refine_proto-to-ren/refine_proto/refine_proto/checkpoints/IP/' + args.checkpoints_file_name + '.pkl'
...
with torch.no_grad():
    ...
    plt.savefig(str('/home/hndx/refine_proto-to-ren/refine_proto/refine_proto/T-SNE/IP/' + args.checkpoints_file_name + '.svg'))
    plt.savefig('/home/hndx/refine_proto-to-ren/refine_proto/refine_proto/T-SNE/IP/' + args.checkpoints_file_name + '.png')
    # plt.show()
