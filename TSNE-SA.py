...
def plotlabels(S_lowDWeights, Trure_labels, name):
    ...
    plt.legend([tempIndex+1 for tempIndex in range(16)])
...
checkpoints_way = '/home/hndx/refine_proto-to-ren/refine_proto/refine_proto/checkpoints/SA/' + args.checkpoints_file_name + '.pkl'


print("checkpoints_way",checkpoints_way)
...
with torch.no_grad():
    ...
    plt.savefig(str('/home/hndx/refine_proto-to-ren/refine_proto/refine_proto/T-SNE/SA/' + args.checkpoints_file_name + '.svg'))
    plt.savefig('/home/hndx/refine_proto-to-ren/refine_proto/refine_proto/T-SNE/SA/' + args.checkpoints_file_name + '.png')
    # plt.show()
